...
// import { BookOpen, Clock, Calendar, FileText, Award, Bell } from 'lucide-react';

// const StudentDashboard = () => {
//   const schedule = [
//     { id: 1, subject: 'Mathematics', time: '9:00 AM', teacher: 'Mrs. Johnson', room: '101' },
//     { id: 2, subject: 'Physics', time: '10:30 AM', teacher: 'Mr. Smith', room: '203' },
//     { id: 3, subject: 'English', time: '1:00 PM', teacher: 'Ms. Brown', room: '105' }
//   ];

//   const assignments = [
//     { id: 1, subject: 'Mathematics', title: 'Quadratic Equations', dueDate: 'Mar 15, 2024', status: 'Pending' },
//     { id: 2, subject: 'Physics', title: 'Newton\'s Laws', dueDate: 'Mar 18, 2024', status: 'Submitted' },
//     { id: 3, subject: 'English', title: 'Essay Writing', dueDate: 'Mar 20, 2024', status: 'Pending' }
//   ];

//   const announcements = [
//     { id: 1, title: 'Annual Sports Day', date: 'Mar 25, 2024', type: 'Event' },
//     { id: 2, title: 'Parent-Teacher Meeting', date: 'Mar 30, 2024', type: 'Meeting' },
//     { id: 3, title: 'Holiday Notice', date: 'Apr 1, 2024', type: 'Notice' }
//   ];
...
//                       <span className="text-sm font-medium text-indigo-600">{announcement.type}</span>
...
//           <div className="p-6">
//             <h2 className="text-lg font-semibold mb-6">Assignments</h2>
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [
        ...
        axios.get('/api/announcements/my-announcements'),
